 ...
 * @param[out] output Output image where the result will be written to. It must have the same format and dimensions as input.
 * @param[in] kernelSize Kernel support size, in pixels.
 * @param[in] sigmaRange Standard deviation in the color spec
 ...
 */
VPI_PUBLIC VPIStatus vpiSubmitBilateralFilter(VPIStream stream, uint32_t backend, VPIImage input, VPIImage output,
